...
public static class UiCommandCatalog
{
    ...
    private static readonly IReadOnlyDictionary<string, (Keys Shortcut, UiGlyph? Glyph, string Description)> Metadata =
        new Dictionary<string, (Keys, UiGlyph?, string)>(StringComparer.Ordinal)
        {
            ...
            ["New Empty File..."] = (Keys.Control | Keys.Alt | Keys.N, UiGlyph.File, "Create an empty file in the active pane."),
            ...
            ["Focus Address"] = (Keys.Control | Keys.L, null, "Select the active pane's address."),
            ["Next Pane"] = (Keys.F6, null, "Focus the next pane in the workspace."),
            ["Connection Manager..."] = (Keys.Control | Keys.Shift | Keys.M, UiGlyph.Connections, "Create, organize, and test connection profiles."),
            ["Key Store..."] = (Keys.Control | Keys.Shift | Keys.K, UiGlyph.Connections, "Import and manage the certificates and private keys shared by saved connections."),
